...
// function collision(ball, tile) {
//   if (ball.x + ball.width + ball.directionX > tile.x && ball.x + ball.width < tile.x + tile.width )
//
//
// }
...
Game.prototype.collisionWithPaddle = function() {
  if (this.ball.y + this.ball.directionY > canvas.height - (this.ball.height + this.paddle.height)) {
    if (this.ball.x + this.ball.directionX > this.paddle.x && this.ball.x + this.ball.directionX < this.paddle.x + this.paddle.width) {
